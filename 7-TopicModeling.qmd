...
library(readtext)
library(tm)
library(topicmodels) #could not install
...
If you run `class(mb.dtm)` in your console you will notice that it now has a class of "DocumentTermMatrix". #Error: object 'mb.dtm not found
