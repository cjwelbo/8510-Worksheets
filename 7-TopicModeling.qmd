...
ac.top.terms.test %>%
  ...
  scale_y_reordered()
```
I am not sure how to get just one topic returned. I can change the number of words returned for each topic, but it's still showing me five topics.
...
mb_texts <- readtext(paste("mbtxt","*.txt", sep="")) #error: File ' ' does not exist.
